    ...
    var t = function() {
        ...
        n = function() {
            function n(t) {
                ...
                var u = r.split(":");
                this.ip = u[0], this.port = u[1] || "15042", this.format = o, this.element = "string" == typeof i ? document.querySelector(i) : i, this.runQuery(), this.timerId = setInterval(this.runQuery.bind(this), a)
            }
            return t(n, [{
                key: "runQuery",
                value: function() {
